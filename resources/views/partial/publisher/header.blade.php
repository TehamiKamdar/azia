        ...
        <div class="navbar-left">
            ...
            <div class="top-menu">
                ...
                <div class="strikingDash-top-menu position-relative">
                    <ul>
                        <li>
                            <a href="{{ route("dashboard", ["type" => "publisher"]) }}" class="{{ \App\Helper\PublisherData::isDashboardActive() }}">Dashboard</a>
                        </li>
                        <li class="has-subMenu">
                            <a href="javascript:void(0)" class="{{ \App\Helper\PublisherData::isAdvertiserActive() }}">Advertisers</a>
                            <ul class="subMenu">
                                <li class="l_sidebar">
                                    <a href="{{ route("publisher.find-advertisers") }}?section=new" data-layout="light">New Advertisers</a>
                                </li>
                                <li class="l_sidebar">
                                    <a href="{{ route("publisher.own-advertisers") }}" data-layout="light">My Advertisers</a>
                                </li>
                                <li class="l_sidebar">
                                    <a href="{{ route("publisher.find-advertisers") }}" data-layout="dark">Find Advertisers</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-subMenu">
                            <a href="javascript:void(0)" class="{{ \App\Helper\PublisherData::isReportActive() }}">Reports</a>
                            <ul class="subMenu">
                                <li class="l_sidebar">
                                    <a href="{{ route("publisher.reports.performance-by-clicks.list") }}" data-layout="light">Clicks Performance</a>
                                </li>
                                <li class="l_sidebar">
                                    <a href="{{ route("publisher.reports.performance-by-transactions.list") }}" data-layout="light">Advertiser Performance</a>
                                </li>
                                <li class="l_sidebar">
                                    <a href="{{ route("publisher.reports.transactions.list") }}" data-layout="dark">Transactions</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-subMenu">
                            <a href="javascript:void(0)" class="{{ \App\Helper\PublisherData::isCreativeActive() }}">Creatives</a>
                            <ul class="subMenu">
                                <li class="l_sidebar">
                                    <a href="{{ route("publisher.creatives.coupons.list") }}" data-layout="dark">Coupons</a>
                                </li>
                                <li class="l_sidebar">
                                    <a href="{{ route("publisher.creatives.text-links.list") }}" data-layout="dark">Text Links</a>
                                </li>
                                <li class="l_sidebar">
                                    <a href="{{ route("publisher.creatives.deep-links.list") }}" data-layout="dark">Deep Links</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-subMenu">
                            <a href="javascript:void(0)" class="{{ \App\Helper\PublisherData::isToolActive() }}">Tools</a>
                            <ul class="subMenu">
                                <li>
                                    <a href="{{ route("publisher.tools.deep-links.generate") }}" class="">Deep Link Generator</a>
                                </li>
                                <li>
        ...
        <div class="navbar-right">
            <ul class="navbar-right__menu">
                    ...
                    <li class="nav-flag-select">
                        <div class="dropdown dropdown-click">
                                <a class="btn-link" href="" aria-expanded="false" aria-haspopup="true" data-toggle="dropdown">
                                    <span style="width: 7px; height: 7px; border-radius: 50%; margin-right: 4px; display: inline-block; position: relative; top: -1px; background: #20c997;"></span> {{ auth()->user()->active_website->name }} (active)
                                    <span data-feather="chevron-down"></span>
                                </a>
                                <div class="dropdown-default dropdown-menu" style="top: 20px !important;">
                                    @foreach($headerWebsites as $website)
                                        <a class="dropdown-item" href="{{ route("publisher.set-website", ["website" => $website->id]) }}">{{ $website->name }}</a>
                                    @endforeach
                                </div>
                        </div>
                    </li>
                ...
                <li class="nav-notification">
                    <div class="dropdown-custom">
                        ...
                        <div class="dropdown-wrapper">
                                    ...
                                    <li class="nav-notification__single nav-notification__single--unread d-flex flex-wrap">
                                        ...
                                        <div class="nav-notification__details">
                                            <p style="max-width: 180px;">
                                                <a href="{{ route("publisher.notification-center.show", $notification->id) }}" class="subject stretched-link text-truncate-custom">
                            ...
                            <a href="{{ route("publisher.notification-center.index") }}" class="dropdown-wrapper__more">See all incoming activity</a>
                        </div>
                    </div>
                </li>
                        ...
                        <div class="dropdown-wrapper card shadow-lg">
                            <div class="card-body py-0 px-0">
                                <div class="faq-support text-center">
                                    <img src="{{ \App\Helper\Static\Methods::staticAsset("img/svg/faq-support.svg") }}" alt="support" class="svg img-fluid w-50">
                ...
                <li class="nav-author">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle">
                            <img id="profilePic" src="{{ \App\Helper\Static\Methods::staticAsset(isset(auth()->user()->publisher->image) && auth()->user()->publisher->image ? auth()->user()->publisher->image : "img/author-nav.jpg") }}" alt="" class="rounded-circle">
                        </a>
                        <div class="dropdown-wrapper">
                            <div class="nav-author__info">
                                <div class="author-img">
                                    <img src="{{ \App\Helper\Static\Methods::staticAsset(isset(auth()->user()->publisher->image) && auth()->user()->publisher->image ? auth()->user()->publisher->image : "img/author-nav.jpg") }}" alt="" class="rounded-circle">
                                </div>
                                <div>
