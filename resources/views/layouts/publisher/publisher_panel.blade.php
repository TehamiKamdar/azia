...
<script src="{{ \App\Helper\Static\Methods::staticAsset("publisher_dashboard/lib/jquery/jquery.min.js") }}"></script>
    ...
    <script src="{{ \App\Helper\Static\Methods::staticAsset("publisher_dashboard/lib/jquery.flot/jquery.flot.resize.js") }}"></script>
    <script src="{{ \App\Helper\Static\Methods::staticAsset("publisher_dashboard/lib/chart.js/Chart.bundle.min.js") }}"></script>
    <script src="{{ \App\Helper\Static\Methods::staticAsset("publisher_dashboard/lib/peity/jquery.peity.min.js") }}"></script>
