                            ...
                            <div class="breadcrumb-action justify-content-center flex-wrap">
                                ...
                                <div class="dropdown action-btn">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                        ...
                                        <a href="{{ route("publisher.export-advertisers", array_merge(['type' => 'csv'], $queryParams)) }}" class="dropdown-item" id="exportCSV">
                            ...
                            <div class="category_sidebar">
                                ...
                                <aside class="product-sidebar-widget mb-30">
                                    ...
                                    <div class="widget_title mb-20">
                                        ...
                                        <a href="javascript:void(0)" id="clearSearchByName" onclick="clearFilter('clearSearchByName')" class="float-right {{ request()->search_by_name ? null : "display-hidden" }}"><small>Clear</small></a>
                                    ...
                                    <div class="card border-0">
                                        <div class="project-search shop-search  global-shadow ">
                                            <form action="/" class="order-search__form">
                                                ...
                                                <input class="form-control mr-sm-2 border-0 box-shadow-none" type="text" id="SearchByName" placeholder="Search by Name" aria-label="Search" value="{{ request()->search_by_name }}">
                                            </form>
                                        </div>
                                    </div>
                                    <!-- Body -->
                                ...
                                <aside class="product-sidebar-widget mb-30">
                                    ...
                                    <div class="widget_title mb-20">
                                        ...
                                        <a href="javascript:void(0)" id="clearSearchByCountry" onclick="clearFilter('clearSearchByCountry')" class="float-right {{ request()->search_by_country ? null : "display-hidden" }}"><small>Clear</small></a>
                                        <div class="clearfix"></div>
                                    </div>
                                    <!-- Title -->
                                    <!-- Body -->
                                        ...
                                        <div class="project-category__select">
                                            <select id="SearchByCountry" class="form-control" multiple>
                                                ...
                                                @foreach($countries as $country)
                                                    <option @if(in_array($country['iso2'], $countriesArr)) selected @endif value="{{ $country['iso2'] }}">{{ $country['name'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card border-0">
                                        <div class="project-category__select">
                                            <select class="js-example-basic-single js-states form-control" id="advertiserType">
                                                ...
                                                <option value="third_party_advertiser" {{ request()->type == "third_party_advertiser" ? "selected" : "" }}>Third-Party Advertisers</option>
                                                <option value="managed_by_linksCircle" {{ request()->type == "managed_by_linksCircle" ? "selected" : "" }}>Managed by LinksCircle</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!-- Body -->
                                ...
                                <!-- End: Aside -->
                                <!-- Start: Aside -->
{{--                                <aside class="product-sidebar-widget mb-30" id="advertiserWrapper">--}}
{{--                                    @if(count($advertiserType))--}}
{{--                                        @include("template.publisher.advertisers.advertiser_checkbox", ['heading' => 'Third Party Advertiser', 'advertisers' => $advertiserType])--}}
{{--                                    @endif--}}
{{--                                </aside>--}}
                                <!-- End: Aside -->
                                <!-- Start: Aside -->
                                <aside class="product-sidebar-widget mb-30">
                                    ...
                                    <div class="widget_title mb-20">
                                        ...
                                        <a href="javascript:void(0)" id="clearSearchByCategory" onclick="clearFilter('clearSearchByCategory')" class="float-right {{ request()->search_by_category ? null : "display-hidden" }}"><small>Clear</small></a>
                                        <div class="clearfix"></div>
                                    </div>
                                    <!-- Title -->
                                    <!-- Body -->
                                        ...
                                        <div class="project-category__select">
                                            <select id="SearchByCategory" class="form-control" multiple>
                                                ...
                                                @foreach($categories as $category)
                                                    <option @if(in_array($category['id'], $categoryArr)) selected @endif value="{{ $category['id'] }}">{{ $category['name'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <aside class="product-sidebar-widget mb-30">
                                    ...
                                    <div class="widget_title mb-20">
                                        ...
                                        <a href="javascript:void(0)" id="clearSearchByPromotionalMethod" onclick="clearFilter('clearSearchByPromotionalMethod')" class="float-right {{ request()->search_by_promotional_method ? null : "display-hidden" }}"><small>Clear</small></a>
                                        <div class="clearfix"></div>
                                    </div>
                                    <!-- Title -->
                                    <!-- Body -->
                                        ...
                                        <div class="project-category__select">
                                            <select id="SearchByPromotionalMethod" class="form-control" multiple>
                                                ...
                                                @foreach($methods as $method)
                                                    <option @if(in_array($method['id'], $promotionalArr)) selected @endif value="{{ $method['id'] }}">{{ $method['name'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="columns-2 col-lg-8 col-md-7 col-sm-8 order-md-1 order-0">
                                        ...
                                        <div class="project-tap b-light">
                                            <ul class="nav" id="ap-tab" role="tablist">
                                                @if(request()->route()->getName() != "publisher.own-advertisers")
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ !request()->section || request()->section == "all" ? "active" : null }}" data-section="all" href="javascript:void(0)" id="allBrands">All Brands</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ request()->section == "new" ? "active" : null }}" data-section="new" href="javascript:void(0)" id="newBrands">New</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ request()->section == "not-joined" ? "active" : null }}" data-section="not-joined" href="javascript:void(0)" id="notJoinedBrands">Not Joined</a>
                                                    </li>
                                                @endif
                                                @if(request()->route()->getName() != "publisher.own-advertisers")
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ request()->section == "pending" ? "active" : null }}" data-section="pending" href="javascript:void(0)" id="pendingBrands">Pending</a>
                                                    </li>
                                                @endif
                                                @if(request()->route()->getName() == "publisher.own-advertisers")
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ request()->section == "joined" || (request()->route()->getName() == "publisher.own-advertisers" && empty(request()->section)) ? "active" : null }}" data-section="joined" href="javascript:void(0)" id="joinedBrands">Joined</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ request()->section == "hold" ? "active" : null }}" data-section="hold" href="javascript:void(0)" id="holdBrands">Hold</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link {{ request()->section == "rejected" ? "active" : null }}" data-section="rejected" href="javascript:void(0)" id="rejectedBrands">Rejected</a>
                                                    </li>
                                                @endif
                                            </ul>
                                        </div>
                                    ...
                                    <div class="project-icon-selected content-center mt-lg-0 mt-25">
                                        <div class="listing-social-link pb-lg-0 pb-xs-2">
                                            <div class="icon-list-social d-flex">
                                                <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center {{ $view == \App\Helper\Static\Vars::PUBLISHER_ADVERTISER_BOX_VIEW ? "active" : null }} ml-xl-20 mr-20" href="javascript:void(0)" onclick="view('{{ \App\Helper\Static\Vars::PUBLISHER_ADVERTISER_BOX_VIEW }}')">
                                                    <span data-feather="grid"></span></a>
                                                <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center {{ $view == \App\Helper\Static\Vars::PUBLISHER_ADVERTISER_LIST_VIEW ? "active" : null }} " href="javascript:void(0)" onclick="view('{{ \App\Helper\Static\Vars::PUBLISHER_ADVERTISER_LIST_VIEW }}')">
                        ...
                        <div class="tab-content mt-25" id="ap-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="ap-overview" role="tabpanel" aria-labelledby="ap-overview-tab">
                                @if($view == \App\Helper\Static\Vars::PUBLISHER_ADVERTISER_LIST_VIEW)
                                    @include("template.publisher.advertisers.advertiser-list", compact('advertisers'))
                                @elseif($view == \App\Helper\Static\Vars::PUBLISHER_ADVERTISER_BOX_VIEW)
                                    @include("template.publisher.advertisers.advertiser-grid", compact('advertisers'))
                                @endif
                            </div>
                        </div>
                    </div><!-- End: .columns-2 -->
