...
<script>
    $(function () {
        'use strict'
        var dailyCurrentMonth = @json($performanceOverview['commission']['dailyCurrentMonth']);
        var dailyPreviousMonth = @json($performanceOverview['commission']['dailyPreviousMonth']);
        var max = @json($performanceOverview['commission']['max_value']);
        var min = @json($performanceOverview['commission']['min_value']);
                        ...
                        <div class="card-body">
                            <div class="card-body-top">
                                <div>
                                    ...
                                    <h2>$ {{ $performanceOverview['sale']['count'] ?? 0 }}</h2>
                                </div>
                                <div>
                                    <label class="mg-b-0">Total Revenue</label>
                                    <h2>$ {{ $performanceOverview['commission']['count'] ?? 0 }}</h2>
                                </div>
                                <div>
                                    <label class="mg-b-0">Total Conversions</label>
                                    <h2>{{ $performanceOverview['transaction']['count'] ?? 0 }}</h2>
                                </div>
                    ...
                    <div class="row row-sm">
                        <div class="col-sm-6">
                            <div class="card card-dashboard-two">
                                <div class="card-header">
                                    <h6>{{ $pendingCurrency === 'USD' ? "$" : $pendingCurrency }} {{ $pending }}<i
                                            class="icon ion-md-trending-up tx-success"></i> <small>18.02%</small></h6>
                        ...
                        <div class="col-sm-6 mg-t-20 mg-sm-t-0">
                            <div class="card card-dashboard-two">
                                <div class="card-header">
                                    <h6>{{ $approvedCurrency === 'USD' ? "$" : $approvedCurrency}} {{ $approved }}<i
                                            class="icon ion-md-trending-down tx-danger"></i> <small>0.86%</small></h6>
                        ...
                        <div class="col-sm-6 mg-t-20 mg-sm-t-0">
                            <div class="card card-dashboard-two">
                                <div class="card-header">
                                    @if(isset($earningOverview['declined']['commission_amount_currency']))
                                        <h6>{{ $earningOverview['declined']['commission_amount_currency'] === 'USD' ? "$" : '' }}
                                            {{ isset($earningOverview['declined']['total_commission_amount']) ? number_format($earningOverview['declined']['total_commission_amount'], 2) : 0 }}<i
                                                class="icon ion-md-trending-down tx-danger"></i> <small>0.86%</small></h6>
                                    @endif
                        ...
                        <div class="col-sm-6 mg-t-20 mg-sm-t-0">
                            <div class="card card-dashboard-two">
                                <div class="card-header">
                                    <h6>$ {{ number_format($earningOverview['paid_status'] ?? 0, 2) }}<i
                                            class="icon ion-md-trending-down tx-danger"></i> <small>0.86%</small></h6>
                                    <p>Payouts</p>
                        ...
                        <div class="col-sm-12 mg-t-20 mg-sm-t-0">
                            <div class="card card-dashboard-two">
                                <div class="card-header" style="display: flex;justify-content: space-between;">
                                    <div>
                                        <h6>$ {{ number_format($earningOverview['paid_status'] ?? 0, 2) }}<i
                                                class="icon ion-md-trending-down tx-danger"></i> <small>0.86%</small>
                                        </h6>
                                        <p>Total Clicks</p>
                                    </div>
                                    <div style="margin-right: 50px;">
                                        <svg width="50px" height="50px" viewBox="0 0 48 48" fill="none"
                                            ...
                                            <path d="M24 4V12" stroke="#000000" stroke-width="4" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M22 22L42 26L36 30L42 36L36 42L30 36L26 42L22 22Z" fill="#2F88FF"
                                                stroke="#000000" stroke-width="4" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path d="M38.1421 9.85795L32.4853 15.5148" stroke="#000000" stroke-width="4"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M9.85787 38.1421L15.5147 32.4852" stroke="#000000" stroke-width="4"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M4 24H12" stroke="#000000" stroke-width="4" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path d="M9.85783 9.85787L15.5147 15.5147" stroke="#000000" stroke-width="4"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </div>
                                </div><!-- card-header -->
            ...
            <div class="row row-sm mg-b-20">
                <div class="col-lg-4">
                    <div class="card card-dashboard-pageviews">
                        <div class="card-header">
                            <h6 class="card-title">5 Highest-Performing Brands Driving the <strong
                                    class="text-primary">Most Sales </strong></h6>
                        </div><!-- card-header -->
                                ...
                                @foreach($topSales as $topSale)
                                    ...
                                    <div class="az-list-item">
                                        <div style="display:flex;gap:20px;align-items: center;">
                                            <img src="{{ $img }}" style="width:70px;height:30px;">
                                            <h6> <a
                                                    href="{{ route("publisher.view-advertiser", ['sid' => $topSale->external_advertiser_id]) }}">
                                                    {{ $topSale->advertiser_name }}
                                                </a></h6>

                                        </div>
                                        <div>
                                            <h6>$ {{ number_format($topSale->total_sales_amount, 2) }}</h6>
