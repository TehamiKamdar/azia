              ...
              <div class="row row-sm">
                <div class="col-sm-6">
                  <div class="card card-dashboard-two">
                    <div class="card-header">
                      <h6>{{ $pendingCurrency === 'USD' ? "$" : $pendingCurrency }} {{ $pending }}<i class="icon ion-md-trending-up tx-success"></i> <small>18.02%</small></h6>
                ...
                <div class="col-sm-6 mg-t-20 mg-sm-t-0">
                  <div class="card card-dashboard-two">
                    <div class="card-header">
                      <h6>{{ $approvedCurrency === 'USD' ? "$" : $approvedCurrency}} {{ $approved }}<i class="icon ion-md-trending-down tx-danger"></i> <small>0.86%</small></h6>
                ...
                <div class="col-sm-6 mg-t-20 mg-sm-t-0">
                  <div class="card card-dashboard-two">
                    <div class="card-header">
                      ...
                      <h6>{{ $earningOverview['declined']['commission_amount_currency'] === 'USD' ? "$" : '' }} {{ isset($earningOverview['declined']['total_commission_amount']) ? number_format($earningOverview['declined']['total_commission_amount'], 2) : 0 }}<i class="icon ion-md-trending-down tx-danger"></i> <small>0.86%</small></h6>
                      @endif
                ...
                <div class="col-sm-6 mg-t-20 mg-sm-t-0">
                  <div class="card card-dashboard-two">
                    <div class="card-header">
                      <h6>$ {{ number_format($earningOverview['paid_status'] ?? 0, 2) }}<i class="icon ion-md-trending-down tx-danger"></i> <small>0.86%</small></h6>
                      <p>Payouts</p>
            ...
            <div class="col-lg-4">
              ...
              @if(count($topSales))
                    ...
                    <div style="display:flex;gap:20px;align-items: center;">
                      ...
                      <h6> <a href="{{ route("publisher.view-advertiser", ['sid' => $topSale->external_advertiser_id]) }}">
