                    ...
                    <div class="row row-sm">
                        <div class="col-sm-6">
                            <div class="card card-dashboard-two">
                                <div class="card-header">
                                    <h6><?php echo e($pendingCurrency === 'USD' ? "$" : $pendingCurrency); ?> <?php echo e($pending); ?><i
                        ...
                        <div class="col-sm-6 mg-t-20 mg-sm-t-0">
                            <div class="card card-dashboard-two">
                                <div class="card-header">
                                    <h6><?php echo e($approvedCurrency === 'USD' ? "$" : $approvedCurrency); ?> <?php echo e($approved); ?><i
                        ...
                        <div class="col-sm-6 mg-t-20 mg-sm-t-0">
                            <div class="card card-dashboard-two">
                                <div class="card-header">
                                    <?php if(isset($earningOverview['declined']['commission_amount_currency'])): ?>
                                        <h6><?php echo e($earningOverview['declined']['commission_amount_currency'] === 'USD' ? "$" : ''); ?>

                                            <?php echo e(isset($earningOverview['declined']['total_commission_amount']) ? number_format($earningOverview['declined']['total_commission_amount'], 2) : 0); ?><i
                                                class="icon ion-md-trending-down tx-danger"></i> <small>0.86%</small></h6>
                                    <?php endif; ?>
                        ...
                        <div class="col-sm-6 mg-t-20 mg-sm-t-0">
                            <div class="card card-dashboard-two">
                                <div class="card-header">
                                    <h6>$ <?php echo e(number_format($earningOverview['paid_status'] ?? 0, 2)); ?><i
                                            class="icon ion-md-trending-down tx-danger"></i> <small>0.86%</small></h6>
                                    <p>Payouts</p>
                                ...
                                <?php $__currentLoopData = $topSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topSale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="az-list-item">
                                        <div style="display:flex;gap:20px;align-items: center;">
                                            ...
                                            <h6> <a
                                                    href="<?php echo e(route("publisher.view-advertiser", ['sid' => $topSale->external_advertiser_id])); ?>">
...
<?php /**PATH C:\Users\lenovo\Downloads\application\resources\views/template/publisher/dashboard/app.blade.php ENDPATH**/ ?>