      ...
      <div class="container">
        ...
        <div class="az-header-menu">
          ...
          <ul class="nav">
            ...
            <li class="nav-item <?php echo e(Route::is("publisher.find-advertisers") || Route::is("publisher.own-advertisers") ? "active" : ""); ?>">
          ...
          <div class="dropdown az-header-notification">
            ...
            <div class="dropdown-menu">
              ...
              <div class="az-notification-list">
                <div class="media new">
                  <div class="az-img-user"><img src="<?php echo e(asset('publisher_dashboard/img/faces/face2.jpg')); ?>" alt=""></div>
                ...
                <div class="media new">
                  <div class="az-img-user online"><img src="<?php echo e(asset('publisher_dashboard/img/faces/face3.jpg')); ?>" alt=""></div>
                  <div class="media-body">
                ...
                <div class="media">
                  <div class="az-img-user"><img src="<?php echo e(asset('publisher_dashboard/img/faces/face4.jpg')); ?>" alt=""></div>
                  <div class="media-body">
                ...
                <div class="media">
                  <div class="az-img-user"><img src="<?php echo e(asset('publisher_dashboard/img/faces/face5.jpg')); ?>" alt=""></div>
                  <div class="media-body">
