...
<?php if($websites): ?>
            ...
            <div id="mainDeeplinkBody">
                    ...
                    <div class="az-dashboard-one-title">
                        <div>
                            ...
                            <?php if(isset($description)): ?>
                                <span class="az-dashboard-text"><?php echo e($description); ?></span>
                            <?php else: ?>
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="landing_url" name="landing_url" placeholder="Enter a Landing Page Optional" <?php if(isset($advertiser->deeplink_enabled) && !$advertiser->deeplink_enabled): ?> <?php endif; ?> style="display: none;">
                        </div>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\Users\lenovo\Downloads\application\resources\views/template/publisher/widgets/deeplink.blade.php ENDPATH**/ ?>