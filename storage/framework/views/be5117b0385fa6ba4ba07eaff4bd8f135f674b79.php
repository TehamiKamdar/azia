                    ...
                    <div class="columns-2 col-lg-8 col-md-7 col-sm-8 order-md-1 order-0">
                        ...
                        <div class="tab-content mt-25" id="ap-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="ap-overview" role="tabpanel" aria-labelledby="ap-overview-tab">
                                <?php if($view == \App\Helper\Static\Vars::PUBLISHER_ADVERTISER_LIST_VIEW): ?>
                                ...
                                <?php elseif($view == \App\Helper\Static\Vars::PUBLISHER_ADVERTISER_BOX_VIEW): ?>
                                    <?php echo $__env->make("template.publisher.advertisers.advertiser-grid", compact('advertisers'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div><!-- End: .columns-2 -->
...
<?php echo $__env->make("layouts.publisher.panel_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Downloads\application\resources\views/template/publisher/advertisers/find.blade.php ENDPATH**/ ?>